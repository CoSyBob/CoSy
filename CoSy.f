...
: eachMfir ( RA fn --  iv ) 	| added | Wed.Aug,20170823.0936
  over refs+> i# dup intVecInit >aux
  0 ?do over i if@ dup execute aux@ i ii! loop
  drop refs- aux> ; 
  
: eachDfr ( LA RA fn -- fv ) 	| each Dyadic on floats , resulting 
...
| building up to Euclidian norm .  See | Tue.Aug,20170822 |  
...
| 20170731 | changed ... css cut aux- ... to  ... css cut\ aux- ... |  
